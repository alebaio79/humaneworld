...
/*$('#FormStepSlider').insertAfter('.en__field--1913506');

$('.step.two').on('click', function(){
$('.form-second-part').addClass('mostrasecondaparte');
 });

$('.step.one').on('click', function(){
$('.form-second-part').removeClass('mostrasecondaparte');
 });

$('#FormStepSlider').insertBefore('.mostrasecondaparte');*/
