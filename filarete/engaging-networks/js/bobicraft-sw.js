...
$('.en__field--2056801  .en__field__item:nth-child(1)').addClass('costattivo');
/**/
...
$('.foche').on('click', function(){
	...
	$('.en__field--2056801   .en__field__item:nth-child(1)').addClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(2)').removeClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(3)').removeClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(4)').removeClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(5)').removeClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(6)').removeClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(7)').removeClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(8)').removeClass('costattivo');
	
 $('.en__field--2056801   .en__field__item.costattivo input').prop('checked', true); 
...
$('.trofeo').on('click', function(){
	...
	$('.en__field--2056801   .en__field__item:nth-child(6)').addClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(2)').removeClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(3)').removeClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(4)').removeClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(5)').removeClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(1)').removeClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(7)').removeClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(8)').removeClass('costattivo');
...
$('.carne').on('click', function(){
	...
	$('.en__field--2056801   .en__field__item:nth-child(5)').addClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(2)').removeClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(1)').removeClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(3)').removeClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(4)').removeClass('costattivo');
...
$('.pellicce').on('click', function(){
	...
	$('.en__field--2056801   .en__field__item:nth-child(3)').addClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(2)').removeClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(1)').removeClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(4)').removeClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(5)').removeClass('costattivo');
...
$('.gabbie').on('click', function(){
	...
	$('.en__field--2056801   .en__field__item:nth-child(4)').addClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(2)').removeClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(1)').removeClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(3)').removeClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(5)').removeClass('costattivo');
...
$('.cani').on('click', function(){
	...
	$('.en__field--2056801   .en__field__item:nth-child(2)').addClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(1)').removeClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(3)').removeClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(4)').removeClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(5)').removeClass('costattivo');
 ...
 $('.en__field--2056801   .en__field__item.costattivo input').prop('checked', true); 
	...
	$('.en__field--2056801   .en__field__item:nth-child(8)').addClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(2)').removeClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(3)').removeClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(4)').removeClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(5)').removeClass('costattivo');
...
$('.carnedue').on('click', function(){
	...
	$('.en__field--2056801   .en__field__item:nth-child(7)').addClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(2)').removeClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(3)').removeClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(4)').removeClass('costattivo');
	$('.en__field--2056801   .en__field__item:nth-child(5)').removeClass('costattivo');
...
$('#en__field_supporter_NOT_TAGGED_717').on('click', function(){
 ...
 $('.en__field--2056801   .en__field__item.costattivo input').prop('checked', true); 
		...
		$('.en__field--2056801    input').click(function(event){
